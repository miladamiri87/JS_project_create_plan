...
//   adding_line_btn.classList.add("disactive");
// }
...
//btn draw////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var draw_btn = document
  .getElementById("draw_btn")
  .addEventListener("click", open_canavas_window);

function open_canavas_window() {
  var canvas_draw = document.querySelector(".canvas_draw");
  canvas_draw.classList.add("show");
    ...
    if (count > 0) {
      ...
      if (isHorizontal) {
        ...
        if (newPoint_x > perv_Point_x) {
          center_point_x =
            Math.abs((newPoint_x - perv_Point_x) / 2) + perv_Point_x;
          center_point_y = perv_Point_y;

          console.log(center_point_x, center_point_y);
          ...
          p_lenght.textContent = document.getElementById("lenght").innerText =
            ...
            "cm";
          console.log(p_lenght);
          canvas_draw.appendChild(p_lenght);
        } else {
          center_point_x =
            Math.abs((newPoint_x - perv_Point_x) / 2) + newPoint_x;
          center_point_y = newPoint_y;
          let p_lenght = document.createElement("p");
          p_lenght.setAttribute(
            "style",
      ...
      /////----------create a line vertical-----------------------------------------------------------------------------------
        ...
        var center_point_y;
        if (newPoint_y > perv_Point_y) {
          center_point_y = Math.abs(
            (newPoint_y - perv_Point_y) / 2 + perv_Point_y - 20
          );
          center_point_x = newPoint_x;
          let p_lenght = document.createElement("p");
          p_lenght.setAttribute(
          ...
          center_point_y = Math.abs(
            Math.abs((newPoint_y - perv_Point_y) / 2) + newPoint_y - 20
          );
          center_point_x = newPoint_x;
          let p_lenght = document.createElement("p");
          p_lenght.setAttribute(
  ...
  close_btn.addEventListener("click", () => {
    canvas_draw.classList.add("hidden");
    canvas_draw.classList.remove("show");
  });
}
